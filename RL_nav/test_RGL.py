...
parser.add_argument('--model_name', type=str, default="rgl_sim_hallway_bottleneck_occlusion_False_rot_bound_8.75_speed_samps_3_rot_samps_10_humans_20_hmin_3_hmax_3")
parser.add_argument('--version_num', type=int, default=0)
parser.add_argument('--trained_steps', type=int, default=66000)
...
model_expansion = f"{args.model_name}_{args.version_num}/{args.model_name}_{args.trained_steps}_steps_no_opt"
...
test(args.save_dir, args.model_name, model_path, "/home/zhujingqi/MultiAgent/CrowdNavigationMPC/RL_nav/configs/env.config", policy_config_file, False)